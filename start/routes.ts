...
Route.post("/check", "LoginController.check").as("check");
...
Route.post("/update-vehicle/:id", "VehiculesController.update").as(
  "updateVehicle"
);
Route.get("/delete-vehicle/:id", "VehiculesController.destroy").as(
  "deleteVehicle"
);
...
Route.post("/update-driver/:id", "ConducteursController.update").as(
  "updateDriver"
);

// Route pour supprimer un conducteur
Route.get("/delete-driver/:id", "ConducteursController.destroy").as(
  "destroyDriver"
);
...
Route.get("/delete-documents/:id", "DocumentsController.destroy").as(
  "doc.destroy"
);
...
Route.get("/locations/create", "LocationsController.create").as(
  "locations.create"
);
Route.post("/locations", "LocationsController.store").as("locations.store");
Route.get("/locations/:id/edit", "LocationsController.edit").as(
  "locations.edit"
);
Route.get("/locations/:id", "LocationsController.update").as(
  "locations.update"
);
Route.get("/delete-locations/:id", "LocationsController.destroy").as(
  "locations.destroy"
);

// payments
Route.get("/payments", "PaymentsController.index").as("payments.index");
Route.get("/payments/create", "PaymentsController.create").as(
  "payments.create"
);
